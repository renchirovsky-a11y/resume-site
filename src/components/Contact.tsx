...
export default function Contact() {
  ...
  return (
    <section id="contact" className="section-band section-rule pb-10">
        ...
        >
          <div className="panel-inner grid lg:grid-cols-[1.1fr_0.9fr]">
            <div className="border-b border-[color:var(--line)] p-7 sm:p-10 lg:border-b-0 lg:border-r">
              ...
              <h2 className="mt-4 max-w-[720px] text-4xl font-black leading-tight text-ivory sm:text-6xl">
                {t("contact.title.1")}
              ...
              >
                <div className="flex items-center gap-4">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1 flex items-center gap-2 truncate font-black text-ivory">
                      @cassedygarcia
                      <ArrowUpRight
                        size={16}
